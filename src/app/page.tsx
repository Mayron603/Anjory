  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative w-full bg-secondary/30 overflow-hidden paint-splatter">
        <div className="absolute top-0 right-0 h-full w-2/3 bg-white/50 rounded-bl-full" />
        <div className="container mx-auto min-h-[80vh] flex items-center justify-center relative z-10 py-16 md:py-0">
          <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-8 w-full">
            ...
            <div className="md:col-span-5 relative flex items-center justify-center h-full">
                {heroImage && (
                    <div className="relative w-72 h-80 md:w-80 md:h-96 bg-white p-3 shadow-2xl transform -rotate-6 transition-transform hover:scale-105 duration-300">
                        <Image
                ...
                <div className="absolute -bottom-24 -left-20 w-48 h-48 md:-bottom-28 md:-left-24 md:w-72 md:h-72">
                    {heroFlowers && (
                        <Image
            ...
            <div className="md:col-span-7 text-center md:text-left flex flex-col items-center md:items-start relative">
               {heroFlowers && (
                    <div className="absolute bottom-0 right-0 w-80 h-80 md:w-96 md:h-96 opacity-70">
                        <Image
                            src={heroFlowers.imageUrl}
                            alt={heroFlowers.description}
                            data-ai-hint={heroFlowers.imageHint}
